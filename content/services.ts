...
const en: ServicesContent = {
  meta: "Done-for-you services that help guests find your booking page: Google Business Profile optimization, Reserve with Google, and full website builds. Your booking page remains the core.",
  hero: {
    eyebrow: "Services",
    headline: "Help guests find your booking page.",
    subhead:
      "We cannot manufacture demand the way a marketplace does, and we will not claim otherwise. What we do is help the right people find you on your own terms, and then direct them straight to your booking page, with no commission in between.",
  },
  services: [
    {
      badge: "The starting point",
      title: "Google Business Profile setup",
      body: "The fastest and most affordable way to start taking bookings. We optimize your Google Business Profile and activate Reserve with Google, so people searching nearby see the correct photos and hours, along with a Book button that leads directly to you.",
      points: [
  ...
  included: {
    ...
    body: "Concierge setup of your booking page is included with every plan. These two services are separate and optional, for venues that also want assistance with being found. They are never a prerequisite for obtaining the core product.",
  },
};
...
const pt: ServicesContent = {
  ...
  hero: {
    ...
    subhead:
      "Não conseguimos gerar procura como um marketplace, e não pretendemos afirmar o contrário. O que fazemos é ajudar as pessoas certas a encontrá-lo nos seus próprios termos, e encaminhá-las diretamente para a sua página de reservas, sem comissão pelo meio.",
  },
  services: [
    {
      badge: "O ponto de partida",
      title: "Configuração do Perfil de Empresa no Google",
      body: "A forma mais rápida e acessível de começar a receber reservas. Otimizamos o seu Perfil de Empresa no Google e ativamos o Reservar com o Google, para que quem procura por perto veja as fotos e horários corretos, bem como um botão de Reservar que conduz diretamente a si.",
      points: [
  ...
  included: {
    ...
    body: "A instalação concierge da sua página de reservas está incluída em todos os planos. Estes dois serviços são separados e opcionais, para espaços que também pretendem apoio para serem encontrados. Nunca constituem um requisito para obter o produto principal.",
  },
};
