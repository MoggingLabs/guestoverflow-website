...
const pt: PromisesContent = {
  ...
  promises: [
    ...
    },
    {
      ...
      body: "Uma subscrição fixa, sem comissão nas suas marcações e sem margem nos pagamentos. Os sinais correm pela sua própria conta, por isso mantém o seu processador e a tarifa integral. Os lembretes por WhatsApp incluem um plafond mensal e, a partir daí, um preço por mensagem transparente e sem margem oculta, e os lembretes por email são sempre gratuitos.",
