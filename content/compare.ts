  ...
  entries: [
    {
      ...
      name: "TheFork",
      sector: "restaurants",
      blurb: "The dominant restaurant marketplace in Portugal — and a per-cover fee on every diner.",
    ...
    },
    {
      ...
      blurb: "Portugal's beauty-booking leader — commission-free, but per-seat and add-on-heavy.",
      headline: "Guest Overflow vs Zappy",
      subhead:
        "Zappy is a strong, commission-free Portuguese tool. We win on the things it doesn't do: real no-show protection, guest self-service, and true on-domain white-label, set up for you.",
      theirModel:
      ...
      theirPains: [
        ...
        "No card-guarantee or automatic no-show charge — only manual upfront prepayment.",
      ...
      ourAnswer: [
        ...
        "Real no-show protection — deposits and card guarantees through your own Stripe.",
    ...
    },
    {
      ...
      ourAnswer: [
        ...
        "Deposits through your own Stripe — no marketplace cut, no payment take-rate.",
      ],
    },
    {
      slug: "fareharbor",
      ...
      ourAnswer: [
        "A flat monthly price — nothing added to your guests' price.",
  ...
  entries: [
    {
      ...
      name: "TheFork",
      sector: "restaurants",
      blurb: "O marketplace de restaurantes dominante em Portugal — e uma taxa por pessoa em cada cliente.",
      headline: "Guest Overflow vs TheFork",
      subhead:
    ...
    },
    {
      ...
      name: "Zappy",
      sector: "spas-wellness",
      blurb: "O líder português das marcações de beleza — sem comissão, mas por lugar e cheio de extras.",
      headline: "Guest Overflow vs Zappy",
      subhead:
      ...
      ourAnswer: [
        ...
        "Proteção real contra faltas — sinais e garantias de cartão pelo seu próprio Stripe.",
    ...
    },
    {
      ...
      ourAnswer: [
        ...
        "Sinais pelo seu próprio Stripe — sem fatia do marketplace, sem margem nos pagamentos.",
      ],
    },
    {
      slug: "fareharbor",
      ...
      ourAnswer: [
        "Um preço mensal fixo — nada acrescentado ao preço dos seus clientes.",
